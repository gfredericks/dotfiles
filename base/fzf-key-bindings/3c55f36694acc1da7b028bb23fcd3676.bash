...
if [[ ! -o vi ]]; then
  ...
  if [ $BASH_VERSINFO -gt 3 ]; then
    bind -x '"\e\C-t": "fzf-file-widget"'
  elif __fzf_use_tmux__; then
    bind '"\e\C-t": " \C-u \C-a\C-k`__fzf_select_tmux__`\e\C-e\C-y\C-a\C-d\C-y\ey\C-h"'
  else
    bind '"\e\C-t": " \C-u \C-a\C-k`__fzf_select__`\e\C-e\C-y\C-a\C-y\ey\C-h\C-e\er \C-h"'
  fi
